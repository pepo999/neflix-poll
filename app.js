...
// function displayCollectionAndre() {
//     const serieListOl = document.getElementById('serie-list')
//     serieListOl.innerHTML = '';
//     for (let i = 0; i < collection.series.length; i++) {
//         const serie = collection.series[i];
//         serieListOl.innerHTML += `
//             <div class="li-serie">
//                 <div>
//                   <img class="li-image" src="${serie.imageUrl}" alt="image from ${serie.title}">
//                   <div>
//                       <span>${serie.title}</span>
//                   </div>
//                       <span>${serie.creator}</span>
